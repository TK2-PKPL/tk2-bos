...
TEAM_MEMBERS = [
    ...
    {"name": "Elizabeth Meilanny Sitanggang", "student_id": "2406433522", "role": "Backend dan autentikasi", "email": "elizabethmeilanny@gmail.com", "bio": "Menangani login Google, validasi token, sesi Django, dan kontrol akses di sisi server.", "accent": "Server side auth"},
    {"name": "Gilang Adjie Saputra", "student_id": "2406399655", "role": "Frontend dan pengalaman pengguna", "email": "gilangadjiesaputra@gmail.com", "bio": "Merancang tampilan halaman publik, dashboard, dan panel pengaturan tema.", "accent": "UI yang rapi"},
    {"name": "Rashika Maharani Putri Rudyanto", "student_id": "2406352670", "role": "Pengujian dan audit", "email": "rashikamaharani@gmail.com", "bio": "Menguji skenario editor dan viewer serta memeriksa jejak aktivitas pada audit log.", "accent": "Quality assurance"},
